// Server-safe registry of allowed icons + their SVG path content.
// No React component imports here — that lives in `place-list-icons-react.tsx`
// (a "use client" module). Keep the two key-lists in sync.
...
// 24x24 viewport SVG inner content. Embedded inside the Leaflet divIcon
// (server-safe path string) and used as the source of truth for what's allowed.
export const PLACE_LIST_ICON_PATHS: Record<ListIconKey, string> = {
  compass:
  ...
  "tent-tree":
    '<circle cx="4" cy="4" r="2"/><path d="M14 7c0-3 2-5 5-5"/><path d="M14 7c0-3-2-5-5-5"/><path d="M14 4v6"/><path d="m14 16-7 5"/><path d="m14 16 7 5"/><path d="M14 16v-6"/><path d="M9 21h10"/>',
  "tree-pine":
  ...
  beer: '<path d="M17 11h1a3 3 0 0 1 0 6h-1"/><path d="M9 12v6"/><path d="M13 12v6"/><path d="M14 7.5c-1 0-1.44.5-3 .5s-2-.5-3-.5-1.72.5-2.5.5a2.5 2.5 0 0 1 0-5c.78 0 1.57.5 2.5.5C9.44 3.5 10 3 12 3s2.56.5 3.5.5c.78 0 1.5-.5 2.5-.5a2.5 2.5 0 0 1 0 5c-.78 0-1.5-.5-2.5-.5Z"/><path d="M5 8v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8"/>',
  pizza:
  ...
  gift: '<rect x="3" y="8" width="18" height="4" rx="1"/><path d="M12 8v13"/><path d="M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7"/><path d="M7.5 8a2.5 2.5 0 0 1 0-5C11 3 12 5 12 8c0-3 1-5 4.5-5a2.5 2.5 0 0 1 0 5"/>',
  ...
  church:
    '<path d="M10 9h4"/><path d="M12 7v5"/><path d="M14 22v-4a2 2 0 0 0-4 0v4"/><path d="m18 22-1.5-3.5a2 2 0 0 0-2-1H9.5a2 2 0 0 0-2 1L6 22"/><path d="m18 22 4-2v-7l-6-3"/><path d="m6 22-4-2v-7l6-3"/><path d="M18 5v17"/><path d="M6 5v17"/><circle cx="12" cy="3" r="1"/>',
  library:
    '<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',
  school:
    '<path d="M14 22v-4a2 2 0 1 0-4 0v4"/><path d="m18 10 4 2v10"/><path d="M18 5v17"/><path d="m2 12 10-7 10 7"/><path d="M6 10v12"/><path d="M2 22h20"/>',
  hospital:
  ...
  dog: '<path d="M11.25 16.25h1.5L12 17z"/><path d="M16 14v.5"/><path d="M4.42 11.247A13.152 13.152 0 0 0 4 14.556C4 18.728 7.582 21 12 21s8-2.272 8-6.444a11.702 11.702 0 0 0-.493-3.309"/><path d="M8 14v.5"/><path d="M8.5 8.5c-.384 1.05-1.083 2.028-2.344 2.5-1.931.722-3.576-.297-3.656-1-.113-.994 1.177-6.53 4-7 1.923-.321 3.651.845 3.651 2.235A7.497 7.497 0 0 1 14 5c0-1.39 1.844-2.556 3.767-2.235 2.823.47 4.113 6.006 4 7-.08.703-1.725 1.722-3.656 1-1.261-.472-1.96-1.45-2.344-2.5"/>',
};

export const ICON_KEYS = Object.keys(PLACE_LIST_ICON_PATHS) as ListIconKey[];

export function iconKey(k: string | null | undefined): ListIconKey {
  return k && k in PLACE_LIST_ICON_PATHS ? (k as ListIconKey) : "map-pin";
}
