...
import TrashEditor, { type TrashRow } from "./TrashEditor";
...
export default async function AdminTrashPage() {
  ...
  return (
    <div>
      <RestoreScroll storageKey="admin:trash:scroll" />
      <PageHeader
        title="Trash"
        description="Soft-deleted items. Restore brings them back; purge is forever."
      />
      <TrashEditor rows={rows} />
    </div>
  );
}
