...
export default function ProjectContainer({ project }: { project: Project }) {
  ...
  return (
    <motion.div
      className="border border-light-third dark:border-dark-third bg-light-secondary dark:bg-dark-secondary hover:border-accent-primary dark:hover:border-accent-primary w-5/6 xl:w-1/3 p-4 mt-4 rounded-lg flex justify-between items-start hover:cursor-pointer transition-all duration-300"
