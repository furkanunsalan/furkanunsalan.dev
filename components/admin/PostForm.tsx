...
import { diffLines, hasRealChanges, type DiffLine } from "./postDiff";
import { lintMarkdown, offsetForLine, type LintIssue } from "./postLint";
...
function OgPreviewDrawer({
  ...
  const src = `/og/writing/${encodeURIComponent(slug)}.png?ts=${ts}`;
